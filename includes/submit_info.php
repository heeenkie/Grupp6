...
if(isset($_POST['submit'])){
	...
	if (empty($about) || empty($first) || empty($last)) {
		...
		if ($resultCheck < 1) {
			$sql = "INSERT INTO info (info_about_me, info_first_name, info_last_name, info_phone, info_foreign, info_sex, info_edu, info_birth) VALUES ('$about', '$first', '$last' , '$phone', '$id', '$sex', '$edu', '$birth')";
